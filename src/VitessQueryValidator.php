...
final class UpdateQueryValidator extends VitessQueryValidator {
	private static bool $isPrimaryVindexColumnValidatorEnabled = true;

	public function __construct(public UpdateQuery $query, public AsyncMysqlConnection $conn) {}

	// Support disabling for tests that are not yet updated to pass with this validatator
	public static function disablePrimaryVindexColumnValidator(): void {
		static::$isPrimaryVindexColumnValidatorEnabled = false;
	}

	public static function enablePrimaryVindexColumnValidator(): void {
		static::$isPrimaryVindexColumnValidatorEnabled = true;
	}
